...
const menu = [
    ...
    },
    {
        path: "",
        render: (
            <div className="sb-sidenav-menu-heading">Quản lý đặt vé</div>
        )
    },
    {
    ...
    },
    {
        path: "",
        render: (
            <div className="sb-sidenav-menu-heading">Quản lý phim</div>
        )
    },
    {
        path: "/admin/add-film",
    ...
    },
    {
        ...
        render: (
            <Link className="nav-link collapsed" to="/admin/film">
                <div className="sb-nav-link-icon"><i className="fas fa-film"></i></div>
                                Danh sách phim
            </Link>
        )
    },
    {
        path: "",
        render: (
            <div className="sb-sidenav-menu-heading">Quản lý rạp</div>
        )
    },
    {
        path: "/admin/theater",
        render: (
            <Link className="nav-link collapsed" to="/admin/theater">
                <div className="sb-nav-link-icon"><i className="fas fa-couch"></i></div>
                                Danh sách rạp
            </Link>
        )
    },
