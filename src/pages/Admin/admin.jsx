    ...
    return (
        <div className={adminClasses}>
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <button onClick={handleToggle} className="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#!"><i className="fas fa-bars"></i></button>
                <div className="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                    
                </div>
                <ul className="navbar-nav ml-auto ml-md-0">
                    
                    <a className="nav-link dropdown-toggle"><i className="fas fa-user fa-fw"></i></a>
