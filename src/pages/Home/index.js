...
import { filmListNowShowing, filmListCommingSoon } from "../../data/data";
    ...
    <div className="warrper">
      ...
      <div className="filmBlock container">
        ...
        <div className="filmBlock__content mt-5">
          {active ? (
            <NowShowing filmList={filmListNowShowing} />
          ) : (
            <NowShowing filmList={filmListCommingSoon} />
          )}
        </div>
      </div>
      ...
      <div className="banner row" style={{ backgroundImage: `url("./images/backapp.jpg")` }}>
        <Banner />
      </div>
    </div>
  );
